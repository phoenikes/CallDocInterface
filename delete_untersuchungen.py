...
"""
Hilfsfunktion zum Löschen aller Untersuchungen eines bestimmten Datums
"""
...
def delete_all_untersuchungen_by_date(mssql_client, date_str: str) -> int:
    """
    Löscht alle Untersuchungen eines bestimmten Datums aus der SQLHK-Datenbank.
    
    Diese Funktion wird vor der eigentlichen Synchronisierung aufgerufen, um sicherzustellen,
    dass keine veralteten oder inkonsistenten Daten in der Datenbank verbleiben.
    
    Args:
        mssql_client: Instanz der MsSqlApiClient-Klasse
