"""
Ruft Untersuchungen für den 04.08.2025 direkt über die API ab.
"""
...
def show_untersuchungen(date_str, server_url="http://192.168.1.67:7007"):
    ...
    filename = f"api_untersuchungen_{date_str.replace('.', '_')}.json"
...
if __name__ == "__main__":
    ...
    server_url = "http://192.168.1.67:7007"
    ...
    show_untersuchungen("04.08.2025", server_url)
