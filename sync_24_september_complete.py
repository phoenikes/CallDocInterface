"""
Vollständige Synchronisation für 24.09.2025 mit Patientenerstellung
"""
...
def sync_24_september():
    """Vollständige Synchronisation für 24.09.2025"""
    ...
    for appt in active_appointments:
        ...
        try:
            ...
            BEGIN
                ...
                VALUES ({piz}, '{sqlhk_patient['Nachname']}', '{sqlhk_patient['Vorname']}', '{sqlhk_patient['Geburtsdatum']}')
            END
            """
...
if __name__ == "__main__":
    result = sync_24_september()
    
    # Speichere Ergebnis
    filename = f"sync_24_september_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
