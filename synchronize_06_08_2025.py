"""
Synchronisiert Termine und Untersuchungen für den 06.08.2025 zwischen CallDoc und SQLHK.

Dieses Skript führt folgende Schritte aus:
1. CallDoc-Termine für den 06.08.2025 abrufen
2. SQLHK-Untersuchungen für den 06.08.2025 abrufen
3. Patienten synchronisieren (einfügen/aktualisieren)
4. Untersuchungen synchronisieren (einfügen/aktualisieren)
5. Obsolete Untersuchungen löschen
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f"synchronize_06_08_2025_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log", encoding="utf-8"),
